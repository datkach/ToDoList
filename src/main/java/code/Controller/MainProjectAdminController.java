...
public class MainProjectAdminController extends MainProjectController {

    @FXML
    public void addProject(ActionEvent actionEvent) throws Exception {

        Parent parent = FXMLLoader.load(getClass().getResource("/View/createProject.fxml"));
